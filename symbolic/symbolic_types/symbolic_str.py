...
class SymbolicStr(SymbolicObject, str):
    ...
    def __getitem__(self, key):
        ...
        if isinstance(key, slice):
            ...
            return self._do_sexpr([self, start, stop],
                                  lambda x, y, z: str.__getitem__(x,
                                                                  slice(y, z)),
                                  "slice", SymbolicStr.wrap)
    ...
    def _replace(self, old, new):
        return self._do_sexpr([self, old, new],
                              lambda x, y, z: str.replace(x, y, z),
    ...
    def replace(self, old, new, maxreplace=-1):
        ...
        assert str(ret) == str.replace(str(self), str(old), str(new),
                                       int(maxreplace))
        return ret
